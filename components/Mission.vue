  <template>
        <section class="relative items-center w-full">
                  <h1 class="mt-16 text-3xl font-bold text-white text-center dark:text-white sm:text-3xl">
                      Nossa missão 
                  </h1>
